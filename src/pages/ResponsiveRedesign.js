      ...
      <div className="widthContainer">
          ...
          <div className="projectInfo">
            <div className="overview">
              <p>
                ...
                and accessibility of an interface. I chose to redesign the
                ordering page of the restaurant{" "}
                <a
                ...
                . This process involved sketching and wireframing to address the
                major usability issues in the layout, and making a visual style
                guide and high fidelity mockup to finalize the style of the new
        ...
        <div className="section">
          ...
          <p>
            ...
            pages. There were also accessibility and layout issues that could be
          ...
          <p>
            ...
            problems I ran into when interacting with the page. I found that the
            main usability issues could be categorized into the following
          ...
          <ul>
            <li>
              <p>
                ...
                receipt looks like it could be a button but is not. At a glance,
                menu seems more like plain text than an interactive page.
              </p>
            </li>
            <li>
              <p>
                <span className="bold">Not fully responsive: </span>The nav bar
                disappears for small screens and some of the text in the nav bar
                gets pushed off as the screen gets smaller. The order function
                doesn't show up on smaller screens if you don't already have
            ...
            <li>
              <p>
                ...
                receipt gets too large, the button to order and some of the food
                items get cut off and you can't scroll the receipt without
                scrolling to the top or bottom of the page. Images need to be
                clicked on separately from the menu item to be seen more
                clearly. You can't navigate between sections without going to
                the top first.
              </p>
            </li>
            <li>
              <p>
                <span className="bold">Memorability:</span> Too many redirection
                links in the banner and nav bar may make it difficult for the
                user to remember where they should go or which link they should
                use to get there. Inconsistency with hover effects may make the
                user forget what is clickable, especially for different links in
                the footer.
              </p>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <p>
                The language of the document is not identified so screen readers
                can't read the page in the correct language.
              </p>
            </li>
            <li>
              <p>
                There are no aria labels, and some images are missing
                alternative text, so images and icons wouldn’t be read out loud.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                Some of the dropdown menus require a click and aren’t accessible
                through the keyboard, which creates problems for those with
        ...
        <div className="section">
          ...
          <p>
            ...
            sketches <span className="bold">(left image)</span> to brainstorm
            new designs for the page, which I combined into a final sketch{" "}
            <span className="bold">(right image)</span>. The final sketch
            included some of my favorite components: a banner with dropdown
            buttons, a two-column display, clickable cards with images, and a
            footer with navigation links. The dropdown buttons and footer
            allowed me to condense the content from the banner to make it less
            crowded. The two-column display worked well for convention reasons
            (physical menus have two columns). The clickable cards helped make
            each menu item more consistent in layout and more easy to interact
            with, as opposed to a small link.
          </p>
          ...
          <p>
            I used my final sketch as the foundation for my wireframes, which I
            made in order to see how the layout looked when scaled properly.
            Some of the key fixes I made addressed accessibility issues like the
            lack of heading structure, and usability issues like poor
            affordances and misalignment. I tackled the issue of poor
            affordances by making interactive components more obvious to the
            user, and spacing issues by reorganizing the placement of content. I
            addressed memorability and efficiency issues by making the layout
            more cohesive.
          </p>
          ...
          <hr className="spacing" />
          <p>
            For the tablet view <span className="bold">(left image)</span>, and
            the phone view <span className="bold">(right image)</span>, I did
            not make major changes in layout relative to the destop view{" "}
            <span className="bold">(above image)</span> because I wanted my
            design to be consistent across different screens. The main
            differences were changing from a two-column display to a one-column
            display, and adding a hamburger menu to fit the nav bar pages. I
            made this change to ensure all the content would fit on smaller
            screen sizes.
          </p>
          <div className="gridContainer">
            <img
          ...
          <p>
            ...
            the page. I was not sure what colors to start with, but I liked the
            restuarant's color scheme, so I made a style guide that fit the
            restaurant's brand. This meant selecting similar colors as the
            ...
            because they have good contrast and can serve different
            purposes. I chose a simpler font so that it would not be too
            distracting, especially since I chose some bright colors. I also
            made sure to include hoverable components to ensure consistency in
            the hover effects.
          </p>
          <div className="imgContainer">
            <img
          ...
          <p>
            ...
            choices in my style guide to build on my wireframes and make a more
            realistic prototype of the final page. I ended up making green the
            primary color of the page, and reserving the bright yellow for
            action items that users should pay attention to (like adding to
            order and checking out). Below are the mockups for Desktop View{" "}
            <span className="bold">(left page)</span>, Tablet View{" "}
            <span className="bold">(middle page)</span>, and Phone View{" "}
            <span className="bold">(right page)</span>.
          </p>
