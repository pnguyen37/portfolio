      ...
      <div className="widthContainer">
          ...
          <div className="projectInfo">
            <div className="overview">
              <p>
                ...
                favoriting app of my own based on the features that I thought
                worked well.
              </p>
            </div>
        ...
        <div className="section">
          ...
          <div className="subsection">
            ...
            <p>
              Since I wanted my app to include data like the title, date of
              release, rating, duration, and genre tags for each movie, I
              planned on using the sorting, filtering, and favoriting functions
        ...
        <div className="section">
          ...
          <div className="subsection">
            ...
            <p>
              When researching existing sorting and filterting functions, I
              wanted to compare a variety of companies. I chose to compare the
              favoriting functions between{" "}
              <a
              ...
              businesses (respectively) and filter and sort within their
              favorited items.
            </p>
          ...
          <div className="subsection">
            ...
            <div className="spanImg">
              <table>
                ...
                <tr>
                  <td>
                    Adding and removing an item to and from favorites is one
                    step.
                  </td>
                  <td>
                    <span className="bold">Yes</span>
          ...
          <div className="subsection">
            ...
            <p>
              When comparing the three pages, I took note of the specific
              features that I liked and why they worked well, and then
              categorized them into the following groups. This helped me focus
              on what I needed to prioritize.
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                filters" text, and the changing headers based on the sort,
                worked well because they were explicit. These labels helped me
                figure out what I needed to click and what I already changed.
              </li>
              <li>
                <span className="bold">Buttons:</span> All websites used icons
                to represent the favoriting function, which looked simple but
                still felt effective in signaling the favorites feature, most
                likely due to convention. Github and Yelp had dropdown buttons
                for the filters, which made it obvious to the user that there
                are multiple options to choose from based on category.
              </li>
            </ul>
          </div>
          <hr className="spacing" />
          <div className="subsection">
            ...
            <ul>
              ...
              <li>
                <p>
                  Icon to represent the favorite button, which can add and
                  remove from the favorite list in one click
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  Different layout between a favorited item and a list item.
                  Less information in the favorited item.
                </p>
              </li>
            </ul>
            <div className="imgContainer" style={{ width: "80%" }}>
              <img
                className="screenshot"
                src={MovieLowfi}
                alt="low fidelity design for movie tracker app"
              ></img>
            </div>
          </div>
          <hr className="spacing" />
          <div className="subsection">
            ...
            <p>
              ...
              components (filtering, sorting, favoriting), I had to consider
              other design deicions as well, such as layout choices and extra
            ...
            <ul>
              <li>
                ...
                scrolls down, they can use the scroll to top button to
                immediately get to the favorites.
              </li>
              <li>
                <p>
                  <span class="bold">Favorite Card:</span> I chose to display
                  the favorite card differently from the movie card by using a
              ...
              <li>
                <p>
                  <span class="bold">Styling:</span> I chose a simple style
                  theme (using blue for an accent color, and red for the
                  favoriting icon). This ensured the buttons would stand out,
                  prioritizing contrast for practicality. I chose to make the
                  primary hovering effect a shadow, to ensure the user sees what
                  they are selecting.
                </p>
              </li>
            </ul>
